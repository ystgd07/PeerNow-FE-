          ...
          useListForPeer2?.datalist.map((item, index) => (
            <div
              ...
              className={`cursor-pointer max-w-sm bg-white shadow-xl rounded-lg overflow-hidden h-60 hover:scale-95 relative ${
                item?.score === 0 ? 'cursor-pointer' : 'cursor-context-menu'
              }`}
              onClick={(e) => {
                ...
                <div className="flex items-center justify-center gap-2 mb-10 text-center">
                  ...
                  <h1 className="-mr-1 text-xl font-bold text-gray-800">
                    ...
                    <span className="text-base">
                      {item?.peer_role === 'PM' ? (
                        <span className="rounded-tl-lg font-black pl-1 pr-0.5 text-[#c28516]">
                          {item?.peer_role}
                        </span>
                      ) : item?.peer_role === 'SM' ? (
                        <span className="rounded-tl-lg font-black pl-1 pr-0.5 text-[#6f00ff]">
                          {item?.peer_role}
                        </span>
                      ) : (
                        <span className="rounded-tl-lg font-black pl-1 pr-0.5 text-[#00ffd5]">
                          {item?.peer_role}
                        </span>
                      )}
                    </span>
                  ...
                  <span className="flex flex-row items-center justify-end ml-2">
                    ...
                    {item?.score === 0 ? (
                      <span>
                        ...
                        <span className="font-extrabold bg-red-200">
                          평가하기
                        </span>
                      </span>
                    ) : (
